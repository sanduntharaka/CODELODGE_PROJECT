			...
			<ul class="nav user-menu">
				...
				<li class="nav-item dropdown has-arrow">
					...
					<div class="dropdown-menu">
						...
						</div> <a class="dropdown-item" href="{{ URL::to('profile.html') }}">My Profile</a> <a class="dropdown-item" href="{{ URL::to('settings.html') }}">Account Settings</a> <a class="dropdown-item" href="login.html">Logout</a> </div>
				</li>
			</ul>
		...
		<div class="sidebar" id="sidebar">
			<div class="sidebar-inner slimscroll">
				<div id="sidebar-menu" class="sidebar-menu">
					<ul>
						<li class="active"> <a href="{{ URL::to('index.html') }}"><i class="fas fa-tachometer-alt"></i> <span>Dashboard</span></a> </li>
