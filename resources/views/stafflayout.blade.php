...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{url('staff/dashboard')}}">
                
                <div class="sidebar-brand-text mx-3">Hostel Admin</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="roomMaster" class="collapse @if(request()->is('admin/rooms*')) show @endif" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{url('staff/create')}}">Add New</a>
                        <a class="collapse-item" href="{{url('staff/room')}}">View All</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="CustomerMaster" class="collapse @if(request()->is('admin/customer*')) show @endif" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{url('staff/customer/create')}}">Add New</a>
                        <a class="collapse-item" href="{{url('staff/customer')}}">View All</a>
                    </div>
                </div>
            </li>
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="{{url('staff/login')}}">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="{{url('staff/login')}}">
