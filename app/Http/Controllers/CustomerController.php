...
class CustomerController extends Controller
{
    ...
    public function staffcustomerindex(){

        $data=Customer::all();
        return view('customer/staffcustomerindex',['data'=>$data]);
    }

    public function staffcustomercreate()
    {
        return view('customer/staffcustomercreate');
    }

    public function staffcustomershow(string $id)
    {
        $data=Customer::find($id);
        return view('customer/staffcustomershow',['data'=>$data]);
    }
